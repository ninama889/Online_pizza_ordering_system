<%@ Page Title="" Language="C#" UnobtrusiveValidationMode="None" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="WebApplication6.Admin.Product" %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                                            runat="server" ErrorMessage="Description is required" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                                                            runat="server" ErrorMessage="Price is required" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4"
                                                            runat="server" ErrorMessage="Quantity is required" ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5"
                                                            runat="server" ErrorMessage="Category is required" ForeColor="Red" Display="Dynamic"
                                                            SetFocusOnError="true" ControlToValidate="ddlCategories"></asp:RequiredFieldValidator>
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                                            ConnectionString="<%$ ConnectionStrings:FoodieDBConnectionString %>" SelectCommand="SELECT [Name], [CategoryId] FROM [Categories]"></asp:SqlDataSource>
                                                    </div>
                                                </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger"
                                                                        ...
                                                                        CausesValidation="false" OnClientClick="return confirm('Do You want to delete this product?')">
                                                                        <i class="ti-trash"></i>
                                                                    </asp:LinkButton>
